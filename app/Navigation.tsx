  ...
  return (
    <header className="w-full py-3 lg:py-4 px-6 bg-gray-100 sticky top-0 border-b border-b-gray-200">
      <Container className="flex justify-between items-center">
        ...
        <nav className={`absolute top-[45px] z-10 left-0 right-0 bg-gray-100 max-md:border-b max-md:border-b-gray-200 md:bg-transparent md:static ${visible ? "flex" : "hidden"} md:!flex md:items-center`}>
